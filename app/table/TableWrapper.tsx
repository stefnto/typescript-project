...
const tableClassNames: InputTableClassNames = {
  ...
  table: {
    wrapper: "shadow-none py-0 pl-0 pr-2 rounded-t-none flex-1 justify-normal max-h-[500px] overflow-y-auto",
  },
  input: {
    base: "min-w-[200px]",
    // input: "text-center"
...
const TableWrapper = ({}) => {
  ...
  const printEditedRows = (editedRows: Array<RowType>) => {
  ...
  return (
    <InputTable
      ...
      handleEditedRows={printEditedRows}
      saveButtonText='Handle save'
